...
exports.printCastCommand = exports.printTenderlySimulationLink = exports.liveDeployer = exports.doOwnershipTransfer = exports.printJsonTransaction = exports.getDeploymentAddress = exports.assertContractVariable = exports.getContractsFromArtifacts = exports.getContractFromArtifact = exports.asAdvancedContract = exports.deploy = void 0;
...
const doOwnershipTransfer = async (opts) => {
    if (opts.isLiveDeployer) {
        ...
        const tx = await opts.proxy.populateTransaction[opts.transferFunc](opts.target.address);
        console.log(`
    ...
    `);
        ...
        await (0, exports.printTenderlySimulationLink)(opts.target.provider, tx);
    }
};
