...
let FaultDisputeGame;
try {
    FaultDisputeGame = require('../artifacts/contracts/dispute/FaultDisputeGame.sol/FaultDisputeGame.json');
}
catch (_b) { }
let IBondManager;
try {
    IBondManager = require('../artifacts/contracts/dispute/interfaces/IBondManager.sol/IBondManager.json');
}
catch (_c) { }
let IDisputeGame;
try {
    IDisputeGame = require('../artifacts/contracts/dispute/interfaces/IDisputeGame.sol/IDisputeGame.json');
}
catch (_d) { }
let IDisputeGameFactory;
try {
    IDisputeGameFactory = require('../artifacts/contracts/dispute/interfaces/IDisputeGameFactory.sol/IDisputeGameFactory.json');
}
catch (_e) { }
let IFaultDisputeGame;
try {
    IFaultDisputeGame = require('../artifacts/contracts/dispute/interfaces/IFaultDisputeGame.sol/IFaultDisputeGame.json');
}
catch (_f) { }
let IInitializable;
try {
    IInitializable = require('../artifacts/contracts/dispute/interfaces/IInitializable.sol/IInitializable.json');
}
catch (_g) { }
let IVersioned;
try {
    IVersioned = require('../artifacts/contracts/dispute/interfaces/IVersioned.sol/IVersioned.json');
}
catch (_h) { }
let LibClock;
try {
    LibClock = require('../artifacts/contracts/dispute/lib/LibClock.sol/LibClock.json');
}
catch (_j) { }
let LibHashing;
try {
    LibHashing = require('../artifacts/contracts/dispute/lib/LibHashing.sol/LibHashing.json');
}
catch (_k) { }
let LibPosition;
try {
    LibPosition = require('../artifacts/contracts/dispute/lib/LibPosition.sol/LibPosition.json');
}
catch (_l) { }
...
let Clone;
try {
    Clone = require('../artifacts/contracts/libraries/Clone.sol/Clone.json');
}
catch (_24) { }
let Constants;
try {
...
let GameTypes;
try {
    GameTypes = require('../artifacts/contracts/libraries/DisputeTypes.sol/GameTypes.json');
}
catch (_27) { }
let Encoding;
try {
