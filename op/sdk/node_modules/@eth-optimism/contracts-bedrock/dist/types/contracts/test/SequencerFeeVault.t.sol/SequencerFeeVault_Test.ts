...
export interface SequencerFeeVault_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_withdraw_toL1_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_withdraw_toL1_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SequencerFeeVault_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_withdraw_toL1_succeeds(overrides?: CallOverrides): Promise<void>;
