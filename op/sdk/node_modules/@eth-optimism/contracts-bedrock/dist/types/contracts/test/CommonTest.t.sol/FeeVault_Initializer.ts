...
export interface FeeVault_InitializerInterface extends utils.Interface {
  functions: {
...
export interface FeeVault_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeVault_InitializerInterface;
