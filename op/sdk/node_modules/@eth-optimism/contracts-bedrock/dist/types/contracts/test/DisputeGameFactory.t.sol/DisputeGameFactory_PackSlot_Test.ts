...
export interface DisputeGameFactory_PackSlot_TestInterface
  ...
  functions: {
    ...
    "testFuzz_packSlot_succeeds(address,uint96)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_packSlot_succeeds",
...
export interface DisputeGameFactory_PackSlot_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DisputeGameFactory_PackSlot_TestInterface;
