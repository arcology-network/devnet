...
export interface SequencerFeeVault_L2Withdrawal_TestInterface
  ...
  functions: {
    ...
    "test_withdraw_toL2_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_withdraw_toL2_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface SequencerFeeVault_L2Withdrawal_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SequencerFeeVault_L2Withdrawal_TestInterface;
  ...
  callStatic: {
    ...
    test_withdraw_toL2_succeeds(overrides?: CallOverrides): Promise<void>;
