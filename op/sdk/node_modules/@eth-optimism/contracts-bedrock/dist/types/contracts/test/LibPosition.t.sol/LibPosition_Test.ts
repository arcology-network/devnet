...
export interface LibPosition_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_attack_correctness(uint8,uint64)": FunctionFragment;
    "testFuzz_defend_correctness(uint8,uint64)": FunctionFragment;
    "testFuzz_depth_correctness(uint8,uint64)": FunctionFragment;
    "testFuzz_indexAtDepth_correctness(uint8,uint64)": FunctionFragment;
    "testFuzz_left_correctness(uint8,uint64)": FunctionFragment;
    "testFuzz_parent_correctness(uint8,uint64)": FunctionFragment;
    "testFuzz_rightIndex_correctness(uint64,uint8,uint64)": FunctionFragment;
    "testFuzz_right_correctness(uint8,uint64)": FunctionFragment;
  };
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "targetSelectors"
      | "targetSenders"
      | "testFuzz_attack_correctness"
      | "testFuzz_defend_correctness"
      | "testFuzz_depth_correctness"
      | "testFuzz_indexAtDepth_correctness"
      | "testFuzz_left_correctness"
      | "testFuzz_parent_correctness"
      | "testFuzz_rightIndex_correctness"
      | "testFuzz_right_correctness"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_attack_correctness",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_defend_correctness",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_depth_correctness",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_indexAtDepth_correctness",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_left_correctness",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_parent_correctness",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "testFuzz_rightIndex_correctness",
    values: [
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_right_correctness",
    values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BigNumberish>]
  ): string;
...
export interface LibPosition_Test extends BaseContract {
  ...
  functions: {
    ...
    testFuzz_attack_correctness(
      ...
      _indexAtDepth: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    testFuzz_rightIndex_correctness(
      _maxDepth: PromiseOrValue<BigNumberish>,
      _depth: PromiseOrValue<BigNumberish>,
      _indexAtDepth: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
